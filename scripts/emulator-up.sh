...
echo no | avdmanager create avd -n test API 29 -k "system-images;android-29;google_apis;x86_64"

# start the emulator
emulator -avd test API 29 -no-audio -no-window -no-accel &
